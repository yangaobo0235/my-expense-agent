...
class DocumentExtractionExternalIntegrationTest {
    ...
    static void externalProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("expense.extraction.mode", () -> "deterministic");
        ...
        registry.add(
                ...
                () -> System.getenv().getOrDefault("EXPENSE_IT_MINIO_BUCKET", "my-expense-agent-documents"));
    }
    ...
    void extractsTextPdfAndPersistsValidatedJson() throws Exception {
        ...
        assertThat(result.documents().getFirst().result().sellerName())
                .isEqualTo("Nanjing Youth Olympic Hotel");
        ...
        String storedJson =
                jdbcClient
                        ...
                        .query(String.class)
                        .single();
        assertThat(storedJson).contains("Nanjing Youth Olympic Hotel", "\"totalAmount\": 288.00");
    }
            ...
            try (PDPageContentStream stream = new PDPageContentStream(document, page)) {
                ...
                for (String line :
                        new String[] {
                            ...
                            "sellerName: Nanjing Youth Olympic Hotel",
                            "buyerName: Jiangnan University",
