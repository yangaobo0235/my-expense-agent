...
class CaseEvidenceServiceTest {
    ...
    void aggregatesPolicyRiskAndSanitizedStepEvidence() {
        ...
        var result = service.get(caseId, "student-1", false);
        ...
        assertThat(result.steps().getFirst().evidence())
                .containsEntry("planVersion", "my-expense-governed-policy-v1");
                ...
                .satisfies(
                        step ->
                                assertThat(step.evidence())
                                        ...
                                        .containsKeys("policyFindings", "applicantContext"));
        assertThat(result.steps())
        ...
        verify(caseService).getOwned(caseId, "student-1");
    }
