...
CREATE TABLE my_expense_agent_audit_log (
    id UUID PRIMARY KEY,
...
CREATE INDEX idx_my_expense_agent_audit_case ON my_expense_agent_audit_log (case_id, occurred_at DESC);
CREATE INDEX idx_my_expense_agent_audit_request ON my_expense_agent_audit_log (request_id);
