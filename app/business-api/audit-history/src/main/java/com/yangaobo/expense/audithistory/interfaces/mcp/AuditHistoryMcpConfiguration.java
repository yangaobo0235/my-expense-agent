...
public class AuditHistoryMcpConfiguration {
    ...
    McpSyncServer auditMcpServer(
        ...
        return McpServer.sync(transport)
                .serverInfo("expense-audit-history-mcp", "1.0.0")
                ...
                .toolCall(tool(mapper, "get_expense_history", "查询员工历史费用", one("employeeId")),
                        (e,r)->result(objectMapper,service.getExpenseHistory(text(r,"employeeId"))))
